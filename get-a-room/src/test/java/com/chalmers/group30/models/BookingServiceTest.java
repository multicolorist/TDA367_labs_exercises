...
public class BookingServiceTest {
    ...
    public void getBookings_roomIsNotInCache() throws IOException, ParseException {
        ...
        when(bookingProviderInterface.getBookings(eq(mockRoom), any(LocalDateTime.class))).thenReturn(Arrays.asList(new Booking[]{new Booking(LocalDateTime.MIN, LocalDateTime.MAX)}));

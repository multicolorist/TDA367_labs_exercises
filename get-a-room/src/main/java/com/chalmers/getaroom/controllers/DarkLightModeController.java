...
import static com.chalmers.getaroom.views.utilities.JavaScriptDOMUtils.setDOMTagAttribute;
...
public class DarkLightModeController implements ComponentEventListener<ClickEvent<Button>> {
    ...
    private void setClientPreferredTheme() {
        preferredClientThemeComponent.getClientDarkModePreference().then(Boolean.class, prefersDark -> {

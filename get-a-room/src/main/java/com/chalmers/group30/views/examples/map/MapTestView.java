...
public class MapTestView extends VerticalLayout {
    ...
    public MapTestView() {
        ...
        try {
            Route route =  Route.fromJSON(new ChalmersMapsAPI().route(new Location(57.696484034673915, 11.975264592149706), new Location(57.700295142972465, 11.965737593691228)));
